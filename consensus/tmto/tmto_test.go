...
func TestReimportMirroredState(t *testing.T) {
	...
	var (
		...
		engine = New(params.AllTmtoProtocolChanges.Tmto, db)
	...
	chain, _ := core.NewBlockChain(db, nil, params.AllTmtoProtocolChanges, engine, vm.Config{}, nil)
	defer chain.Stop()

	blocks, _ := core.GenerateChain(params.AllTmtoProtocolChanges, genesis, engine, db, 3, func(i int, block *core.BlockGen) {
